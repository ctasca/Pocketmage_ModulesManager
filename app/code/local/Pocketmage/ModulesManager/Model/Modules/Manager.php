 ...
 */
class Pocketmage_ModulesManager_Model_Modules_Manager
{
    protected $_xml;
     ...
     *
     * @return Pocketmage_ModulesManager_Model_Data_Simplexml
     */
    protected function getXml()
    {
        return new Pocketmage_ModulesManager_Model_Data_Simplexml($this->_moduleXmlPath, new Varien_Io_File());
    }
